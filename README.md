...
De Ronde Kaart is a fast, open-source web mapping application built around simplicity and transparency. Focused on visualising geospatial models, their data, and their underlying mathematical relations. And is designed for collaborative exploration.
